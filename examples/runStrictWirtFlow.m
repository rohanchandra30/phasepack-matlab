%%                   testStrictWirtFlow.m

% This test file strictly implements the Wirtinger Flow solver. The code
% builds a synthetic formulation of the Phase Retrieval problem, b = |Ax|
% and computes an estimate to x. The code finally plots a convergence curve
